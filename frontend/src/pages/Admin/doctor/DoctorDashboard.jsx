...
const DoctorDashboard = () => {
  ...
  const dashData = useDoctorStore((state) => state.dashData);
  const getDashData = useDoctorStore((state) => state.getDashData);
  const cancelAppointment = useDoctorStore((state) => state.cancelAppointment);
  const completeAppointment = useDoctorStore(
